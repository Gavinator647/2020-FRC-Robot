...
public class RobotMap {
    ...
    public static final int INTAKE_SOLENOID_RETRACT = 7;
    public static final int FRONT_RIGHT_DRIVE = 3;
    public static final int FRONT_LEFT_DRIVE = 2;
    public static final int BACK_RIGHT_DRIVE = 1;
    public static final int BACK_LEFT_DRIVE = 0;
    public static final int TOP_CHAMBER = 5;
    public static final int BOTTOM_CHAMBER = 4;
    ...
    public static final int RIGHT_DRIVE_ENCODER_FIRST = 2;
    public static final int RIGHT_DRIVE_ENCODER_SECOND = 3;
}
